...
public class Board extends JPanel implements ActionListener {
	...
	private void loadImages() {
		...
		pacman1 = new ImageIcon("src/resources/PacMan1.gif").getImage();
		pacman2up = new ImageIcon("src/resources/PacMan2up.gif").getImage();
		pacman3up = new ImageIcon("src/resources/PacMan3up.gif").getImage();
		pacman4up = new ImageIcon("src/resources/PacMan4up.gif").getImage();
		pacman2down = new ImageIcon("src/resources/PacMan2down.gif").getImage();
		pacman3down = new ImageIcon("src/resources/PacMan3down.gif").getImage();
		pacman4down = new ImageIcon("src/resources/PacMan4down.gif").getImage();
		pacman2left = new ImageIcon("src/resources/PacMan2left.gif").getImage();
		pacman3left = new ImageIcon("src/resources/PacMan3left.gif").getImage();
		pacman4left = new ImageIcon("src/resources/PacMan4left.gif").getImage();
		pacman2right = new ImageIcon("src/resources/PacMan2right.gif").getImage();
		pacman3right = new ImageIcon("src/resources/PacMan3right.gif").getImage();
		pacman4right = new ImageIcon("src/resources/PacMan4right.gif").getImage();
	}
